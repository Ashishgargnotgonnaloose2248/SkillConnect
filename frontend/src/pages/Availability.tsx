...
export default function Availability() {
  ...
  function saveSkills(next: SkillItem[]) {
    setSkills(next);
    try {
      localStorage.setItem("sc_skills", JSON.stringify(next));
    } catch {}
  }
  function saveAvailability(next: AvailabilitySlot[]) {
    setSlots(next);
    try {
      localStorage.setItem("sc_availability", JSON.stringify(next));
    } catch {}
  }
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Design, Coding, Editing"
                    />
                  </div>
                </div>
                <div>
            ...
            <CardContent>
              <div className="space-y-3">
                {slots.map((slot, idx) => (
                  <div
                    key={slot.day}
                    className="grid grid-cols-[60px,1fr,1fr] items-center gap-3"
                  >
              ...
              <Button
                ...
                variant="secondary"
                className="mt-4"
                onClick={() => toast({ title: "Availability saved" })}
              >
                Save availability
              </Button>
            </CardContent>
